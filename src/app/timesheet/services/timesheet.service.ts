...
export class TimesheetService {
  ...
  getTimeSheetsPorEmpleado(empleadoId: number = 0, proyectoId: number = 0, unidadId: number = 0, mes: number = 0) {
    return this.http.get<TimesheetsPorEmpleadoResponse>(`${this.baseUrl}api/Timesheet/TimeSheets/Filtro/${empleadoId}/${proyectoId}/${unidadId}/${mes}`)
  }
